class DrinksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @drink.save
        format.html { redirect_to new_consumed_drink_path(drink_id: @drink), notice: "Thanks! We've added the drink to our database."  }
  ...
  private
    ...
    def drink_params
      params.require(:drink).permit(:name, :drink_category_id, :producer_id, :abv, :drink_type_id, :year, :picture)
    end
end
